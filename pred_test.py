...
# function to download and preprocess real-time data for XRP/USDT
def get_data():
    # use Binance API to download real-time data for XRP/USDT
    url = "https://api.binance.com/api/v1/klines?symbol=XRPUSDT&interval=1m&limit=100"
    r = requests.get(url)
    data = r.json()
